...
/*jQuery.validator.addMethod("ipRange", function(value) {
	ipRangeError = checkIpAddress();
	if (ipRangeError.length > 0) {
		return false;
	}
	return true;
}, checkIpAddress);*/
 ...
 * @param   param       临界值
 */	
jQuery.validator.addMethod("ne", function(value, element, param) {
	return value != param;
}, jQuery.format("输入值必须小于{0}!"));
