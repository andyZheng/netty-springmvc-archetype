...
public class ReflectionUtils {
    ...
    public static String fetchElementPropertyToString(final Collection<?> collection, final String propertyName,
        ...
        final List<?> list = fetchElementPropertyToList(collection, propertyName);
     ...
     */
    public static void convertToUncheckedException(final Exception e) throws IllegalArgumentException {
